...
import { PrismaClient, AdminUserRole, HomePageSectionType, PageStatus } from "@prisma/client";
...
if (!backupPath) {
  console.error("Usage: node scripts/import-content-from-backup.mjs <backup-json-path>");
  process.exit(1);
}
...
console.log(`Import termine depuis ${resolvedBackupPath}`);
