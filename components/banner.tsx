...
export function Banner({
  ...
  return (
    <section className="surface-panel relative overflow-hidden rounded-2xl border border-white/10 bg-[#0b0b10]">
      <div className="grid min-h-[260px] md:min-h-[300px] md:grid-cols-[minmax(0,0.88fr)_minmax(340px,1.12fr)]">
        <div className="relative z-10 flex items-end border-b border-white/10 p-6 md:border-r md:border-b-0 md:p-8">
          <div className="max-w-[480px]">
            <div className="text-[11px] font-semibold uppercase tracking-[0.28em] text-rose-200/80">
              Documentation officielle
            </div>
            <h1 className="mt-3 max-w-2xl text-4xl font-black tracking-[-0.06em] text-white md:text-5xl">{title}</h1>
            <p className="mt-3 max-w-2xl text-sm leading-7 text-white/68 md:text-base">{description}</p>
          </div>
        </div>
